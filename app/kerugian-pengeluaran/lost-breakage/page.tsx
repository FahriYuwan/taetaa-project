...
export default function KerugianRawPage() {
  ...
  const filteredItems = kerugian?.filter(item => {
      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-col items-end gap-4">
            ...
            {/* Baris Bawah: Filter dengan Border Tipis untuk Memisahkan Visual */}
              ...
              {loading ? (
                ...
                filteredItems.map((p) => (
                  <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-400 text-xs italic">{p.notes || 'Contoh: Karat, Rusak/bocor, atau bolong'}</td>
                  </tr>
                ))
              )}
            </tbody>
